const SoftSkills = (props) => {
    ...
    return(
        <section id='softSkills' className="portfolio_section px-10 lg:px-40 pt-24 text-center">
            <h2>Soft Skills</h2>          
            {
                Object.entries(softSkills).map(([key, value]) => (
                    <div key={key} className="skilldiv inline-block m-3 p-4 bg-black bg-opacity-50 rounded-2xl w-1/6">
